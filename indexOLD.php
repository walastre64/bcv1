...
###################################################
$pagina = file_get_contents("http://www.bcv.org.ve", false, stream_context_create($arrContextOptions));
...
########## Actualiza valor del EURO #######
 ...
 #######  Actualizando Tablas 
   ...
   ######################################################################################
   actualizar_tr_pend($CODUSD,$CODEUR);
   actualizar_tr_pend_farmacia($CODUSD,$CODEUR);
?>